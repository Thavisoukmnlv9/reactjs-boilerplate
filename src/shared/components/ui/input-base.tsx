  ...
  return (
    ...
    >
      <Primitive.div
        ...
        className={cn(
          'flex min-h-9 cursor-text items-center gap-2 rounded-md border border-input bg-transparent px-3 py-1 text-base shadow-xs outline-none transition-[color,box-shadow] selection:bg-primary selection:text-primary-foreground md:text-sm dark:bg-input/30',
...
function InputBaseInput({
  ...
  return (
    <Primitive.input
      ...
      className={cn(
        'w-full flex-1 bg-transparent file:border-0 file:bg-transparent file:font-medium file:text-foreground file:text-sm placeholder:text-muted-foreground focus:outline-none disabled:pointer-events-none',
        className
      )}
      {...props}
    />
